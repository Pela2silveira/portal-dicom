...
- The portal favicon must be served by the portal/Nginx surface itself, including a stable `/favicon.ico` entrypoint backed by a local `.ico` asset, and must not depend on OHIF asset routing.
