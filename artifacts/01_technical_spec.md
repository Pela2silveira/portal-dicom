...
- En la UI de paciente, compartir estudio local debe exponerse con dos acciones distintas: `WhatsApp` como CTA principal que abre `wa.me`/WhatsApp Web con el enlace mágico ya armado, y `Compartir` como acción secundaria genérica que usa share nativo del navegador cuando existe y, si no, cae a copiar el enlace o mostrarlo.
