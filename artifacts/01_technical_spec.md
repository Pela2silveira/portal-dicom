...
8. Si el formulario ya envía filtros de fecha o modalidad, esa primera sincronización remota debe usar exactamente esos filtros y no un horizonte independiente del backend.
