...
- `local_partial` no bloquea: `getStudyOperationalState` conserva las URLs de visor para estudios presentes aunque estén parciales; solo deja de enmascararlos como `local_complete`. Remediación (reintento por series faltantes con reintentos/backoff/timeout configurables) queda para PR B.
