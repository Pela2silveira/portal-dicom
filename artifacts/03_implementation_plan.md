...
- **Sync inicial paciente alineado al formulario**: el primer QIDO del flujo paciente usa los filtros efectivamente enviados por la UI; no existe un horizonte independiente en backend para ese primer request.
