...
- In the patient study card UX, WhatsApp is the primary share action and generic share is secondary: the first CTA should prefer the explicit `WhatsApp` deep link, while `Compartir` remains as a fallback to native browser sharing / clipboard flows.
