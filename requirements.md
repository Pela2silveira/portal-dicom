...
* **Excepciones de matrícula profesional:** `config.json` puede definir `professional.license_exceptions` como una lista explícita de DNI/username habilitados a ingresar sin matrícula activa; esa excepción no debe saltear la verificación de `habilitado == true`.
